                ...
                {input
                  ? input?.Capability?.Layer?.Layer?.map((layer) => (
                      <tr key={layer.Title}>
                        ...
                        <td>
                          <button
                            onClick={() => onSelectLayer(layer.Name, "WMS")}
                          >
                            +
                          </button>
                        </td>
              ...
              <tbody>
                {input?.Contents?.Layer?.map((layer, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      {layer.Title ? layer.Title : "No Abstract available"}
                    </td>
                    <td>
                      <button
                        onClick={() => onSelectLayer(layer.Identifier, "WMTS")}
                      >
                        +
                      </button>
                    </td>
              ...
              <tbody>
                {input?.FeatureTypeList?.FeatureType?.map((layer, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <button onClick={() => onSelectLayer(layer.Name, "WFS")}>
                        +
                      </button>
                    </td>
                  </tr>
